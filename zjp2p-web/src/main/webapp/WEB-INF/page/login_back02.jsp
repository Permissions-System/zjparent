...
<script type="text/javascript">
	$(function(){
		...
		$("#qq").click(function(){
			$("#frmLogin").action="/indexlogin.do";
			$("#frmLogin").submit();
			$("form:first").action="/indexlogin.do";
			$("form:first").submit() 
			return true;
		});
	});
	...
	function doLogin(){
		...
		//$("#frmLogin").action="/indexlogin.do";
		//$("#frmLogin").submit();
		document.frmLogin.action="/indexlogin.do";
...
<div class="login"><!--login  start-->
  ...
  <div class="login_right">
    <div class="login_h">
      ...
      <div class="login_input" style="font-size:13px; font-family:'微软雅黑'; color:#565A5C; "><form id="frmlogin" name="frmlogin" action="login.do" method="post"><table width="550" border="0" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <tr>
    ...
    <td width="46"><a href="javascript:doLogin();"><img id="qq" src="${ctx}/static/images/qq.png" width="29" height="29"   alt=""/></a> </td>
