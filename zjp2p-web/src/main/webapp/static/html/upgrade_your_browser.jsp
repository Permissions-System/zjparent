<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<!DOCTYPE html>
<!-- saved from url=(0073)http://cdn.dmeng.net/upgrade-your-browser.html?referrer=%27+location.href -->
<html lang="UTF-8"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta charset="UTF-8">
...
<div class="line"></div>
<h2>更先进的浏览器</h2>
<p>推荐使用以下浏览器的最新版本。如果你的电脑已有以下浏览器的最新版本则直接使用该浏览器访问<b id="referrer">&nbsp;<a href="http://www.biifoo.com">www.biifoo.com</a>&nbsp;</b>即可。</p>
<ul class="browser">
<li><a href="http://www.google.cn/chrome/browser/index.html?hl=zh-CN&standalone=1"><img src="${ctx}/static/images/chrome.jpg" alt="谷歌浏览器" width="34" height="34"> 谷歌浏览器<span>Google Chrome</span></a></li>
<li><a href="http://download.firefox.com.cn/releases/stub/official/zh-CN/Firefox-latest.exe"><img src="${ctx}/static/images/firefox.jpg" alt="火狐浏览器" width="34" height="34"> 火狐浏览器<span>Mozilla Firefox</span></a></li>
<li><a href="http://windows.microsoft.com/zh-cn/internet-explorer/download-ie"><img src="${ctx}/static/images/ie.jpg" alt="IE浏览器" width="34" height="34"> IE浏览器<span>Internet Explorer</span></a></li>
<li><a href="http://jifendownload.2345.cn/jifen_2345/2345chrome_k2345886.exe" title="基于 Chromium 开源项目的国产浏览器"><img src="${ctx}/static/images/2345chrome.png" alt="2345加速浏览器" width="34" height="34"> 加速浏览器 <span>2345 chrome</span></a></li>
<div class="clean"></div>
</ul>
<div class="line"></div>
<h2>为什么会出现这个页面？</h2>
