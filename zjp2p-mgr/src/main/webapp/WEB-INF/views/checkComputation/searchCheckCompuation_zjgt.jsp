...
<script type="text/javascript">
	...
	function exportExcel(){
   	  if(isCheck){
   		var action="${path}/checkExport/export_zj";
...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		...
		<table id="datagrid" title="富友核算结果数据查询" class="easyui-datagrid"   fit="true"
			url="${path}/CheckSearchData_zjgt/datagrid"    
			...
			<thead>
				...
				<!-- 	<th data-options="field:'mchntSsn',width:150" >流水号</th> -->
					...
					<th data-options="field:'currentFuBalance',width:80,align:'right',formatter:ThousandsNumber" >余额</th>
				<!-- <th data-options="field:'txnAmtSuc',width:100,align:'right',formatter:ThousandsNumber" >成功交易金额</th> -->
					...
					<th data-options="field:'sourCode',width:60" >数据来源</th>
    ...
    <td>数据类型：<input id="busiTp" name="busiTp"  editable="false" class="easyui-combobox" name="dept" data-options="valueField:'key',textField:'value',url:'${path}/getCombox/boxData_zjgt',required:true"></td>
	<td>核算结果：<input id="checkflag" name="checkflag" editable="false"  class="easyui-combobox" name="dept" data-options="valueField:'key',textField:'value',url:'${path}/getCombox/getCheckList',required:true"></td>
