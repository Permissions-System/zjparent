...
<div class="backcontent">
  <div class="breadcrumb">
    <ol class="am-breadcrumb am-breadcrumb-slash">
      <li>首 页</li>
      <li>资讯管理</li>
      <li class="am-active">新 闻</li>
    </ol>
  </div>
  <div class="searchpanel">
    <form class="am-form-inline" role="form">
      <div class="am-form-group" style="margin-top:10px;">
        <label for="doc-ipt-3" class="am-u-sm-6 am-form-label" >新闻名称：</label>
  ...
  <a href="editNews.do"><button type="button" class="am-btn am-btn-primary" style="margin-left:15px; margin-top:20px; float:left;"><span class=" am-icon-plus-square">　发布新闻</span></button></a>
  ...
  <div class="tablecontent"><table class="am-table am-table-bordered am-table-striped am-table-hover" style="text-align:center;">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="viewNews.do?id=${article.id}" target="_blank"><button type="button" class="am-btn am-btn-secondary am-btn-sm">查看</button></a>
            	<a href="editNews.do?id=${article.id}"><button type="button" class="am-btn am-btn-secondary am-btn-sm">编辑</button></a> 
            	<a href="deleteNews.do?id=${article.id}"><button type="button" class="am-btn am-btn-secondary am-btn-sm" onclick="return confirm('删除吗?')">删除</button></a>  
            </td>
        </tr>
    </tbody>
    </c:forEach>
...
<form id="getTopost" action="queryNewsList.do" method="post">
