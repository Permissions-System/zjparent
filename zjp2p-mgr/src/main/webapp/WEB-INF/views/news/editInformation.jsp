...
<body>
 ...
 <form action="saveInformation.do" method="post" >
 <input type="hidden" name="id" value="${article.id}"/>
    <table width="90%" border="0" cellpadding="0" cellspacing="0" class="tabl2">
      <tr>
         <td>
          <label for="textfield">百富故事标题:</label>
      ...
      <tr>
        ...
        <td><button type="button" name="button" value="" onclick="location='queryInformationList.do'">取消</button>
        <td colspan="1"></td>
      </tr>
      </table></form>   
</body>
