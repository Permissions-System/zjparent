...
<body>
	<table style="width:100%;border:0px;align:center;cellpadding:0;cellspacing:0">
		...
		<tr>
			<td>
				<table id="empInfoTable" style="width:95%;border:0px;">
					<tr>
						<td class="trwidth">
							<div align="right">法人姓名:&nbsp;&nbsp;&nbsp;</div>
						</td>
						<td width="30%" class="td_info">${person.name}</td>
						<td class="trwidth">
					...
					<tr>
						...
						<td width="30%"><c:forEach items="${genders}" var="gender">
						...
						<td width="*">${person.identNo}</td>
					</tr>
					<tr>
						<td class="trwidth">
							<div align="right">员工年龄:&nbsp;&nbsp;&nbsp;</div>
						</td>
						<td width="30%">${person.age}</td>
						<td class="trwidth">
					...
					<tr>
						...
						<td width="30%">${person.userAccount.mobile}<%--${userAccount.mobile } --%>
						</td>
						<td class="trwidth">
							<div align="right">联系地址:&nbsp;&nbsp;&nbsp;</div>
						</td>
						<td width="*" class="td_info">${person.address}</td>
					</tr>
					<tr>
						<td class="trwidth">
							<div align="right">邮箱地址:&nbsp;&nbsp;&nbsp;</div>
						</td>
						<td width="30%">${person.userAccount.email}<%--${userAccount.email } --%>
						</td>
						<td class="trwidth">
							<div align="right">紧急联络人:&nbsp;&nbsp;&nbsp;</div>
						</td>
						<td width="*" class="td_info">${person.urgentPerson}</td>
					</tr>
					<tr>
						<td class="trwidth">
							<div align="right">紧急联系方式:&nbsp;&nbsp;&nbsp;</div>
						</td>
						<td width="30%">${person.urgentTel}</td>
						<td class="trwidth">
					...
					<tr>
						...
						<td width="30%">${tradeName}</td>
						<td class="trwidth">
							<div align="right">所在公司:&nbsp;&nbsp;&nbsp;</div>
						</td>
						<td width="*" class="td_info">${person.company}</td>
					</tr>
					<tr>
						<td class="trwidth">
							<div align="right">公司职位:&nbsp;&nbsp;&nbsp;</div>
						</td>
						<td width="30%" class="td_info">${person.position }</td>
						<td class="trwidth">
					...
					<tr>
						...
						<td width="30%" class="td_info">${person.school}</td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<table style="width:100%;border:0px;align:center;cellpadding:0;cellpadding:0;cellspacing:0;">
		<tr>
			<td style="width:100%;height:28px;background-color:#E0EEEE">
				<span>&nbsp;&nbsp;&nbsp;法人代表证件列表</span>
			</td>
		...
		<tr>
			<td>
				<table style="width:100%;height:100%;border:0px;cellpadding:2;cellspacing:3;align:center">
					<tbody>
						<tr>
							<td class="blank_td"></td>
							<td class="td_label"><label>名称&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
							<td align="center" style="font-size: 12px; font-weight: bold; color: #333;"><label>操作</label></td>
							<td class="td_input" style="font-size: 12px; font-weight: bold; color: #333;"><label>&nbsp;&nbsp;&nbsp;状态</label> </td>
							<td class="td_description" style="font-size: 12px; font-weight: bold; color: #333;"><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注</label></td>
							<td class="blank_td"></td>
						</tr>
						<tr>
							<td><hr style="width:100%;align:center;size:0;"></td>
							<td><hr style="width:100%;align:center;size:0;"></td>
							<td><hr style="width:100%;align:center;size:0;"></td>
							<td><hr style="width:100%;align:center;size:0;"></td>
							<td><hr style="width:100%;align:center;size:0;"></td>
						...
						<tr>
							<td class="blank_td"></td>
							<td class="td_label"><label>身份证正面复印件:</label></td>
							<td align="center"><a
								onclick="javascript:viewImgFile('${p1File.filePath}')"
								class="easyui-linkbutton">预览</a> <a
								onclick="javascript:downloadFile('${p1File.filePath}')"
								class="easyui-linkbutton">下载</a></td>
							<td class="td_input">
							...
							<td class="td_description">${p1File.description}</td>
							<td class="blank_td"></td>
						</tr>
						<tr>
							<td class="blank_td"></td>
							<td class="td_label"><label>身份证反面复印件:</label></td>
							<td align="center"><a
								onclick="javascript:viewImgFile('${p2File.filePath}')"
								class="easyui-linkbutton">预览</a> <a
								onclick="javascript:downloadFile('${p2File.filePath}')"
								class="easyui-linkbutton">下载</a></td>
							<td class="td_input">
								<c:forEach items="${fileStatus}" var="status">
							...
							<td class="td_description">${p2File.description}</td>
							<td class="blank_td"></td>
						</tr>
						<c:forEach items="${p0FileList}" var="p0File">
							<tr>
								<td class="blank_td"></td>
								<td class="td_label"><label>其他文件:</label></td>
								<td align="center"><a
									onclick="javascript:viewImgFile('${p0File.filePath}')"
									class="easyui-linkbutton">预览</a> <a
									onclick="javascript:downloadFile('${p0File.filePath}')"
									class="easyui-linkbutton">下载</a></td>
								<td class="td_input">
									<c:forEach items="${fileStatus}" var="status">
								...
								<td class="td_description">${p0File.description}</td>
								<td class="blank_td"></td>
							</tr>
						</c:forEach>
					</tbody>
