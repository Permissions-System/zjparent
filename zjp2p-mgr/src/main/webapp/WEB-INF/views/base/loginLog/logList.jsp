    ...
    <div class="datagrid-toolbar" data-options="region:'north',split:true,title:'查询'" style="height:130px;padding:20px 0px 10px 30px">
        <form id="queryForm" method="post" novalidate>
            <table class="datagrid-toolbar" style="width:100%;height:70%;border:0px;font-size:12px ">
                <tr>
                   <td><label for="qyStaffName">员工名:</label></td>
                   <td><input id="qyStaffName" name="staffName" class="easyui-validatebox" style="width:155px;" ></td>
                   <td><label for="qyIdentNo">身份证号:</label></td>
                   <td><input id="qyIdentNo" name="identNo" style="width:160px;" class="easyui-validatebox"></td>
...
function queryInfo(){
    ...
    $('#itLogInfo').datagrid('load',{
        staffName: $('#qyStaffName').val(),
        identNo:$('#qyIdentNo').val(),
...
function initDataGrid(){
    $("#itLogInfo").datagrid({
        ...
        singleSelect:true,
        fit:true,
        url: '${ctx}/base/loginLog/log/getInfoByPage',
        ...
        columns:[[
            ...
            {title:'员工编号',field:'staffNo',width:100},
            {title:'员工名',field:'staffName',width:100},
            {title:'身份证号',field:'identNo',width:120},
            {title:'IP地址',field:'ipAddress',width:100},
