...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		...
		<table id="datagrid" title="投资管理数据分析(1首次投资 2剔除重复投资 3不包含被邀请的 4定期)" class="easyui-datagrid" fit="true"
			url="${path}/lendInfo/datagrid"  pagination="true" toolbar="#tb"
		...
		<div id="tb" style="padding:5px;height:auto">
			<div>
				<form id="paramForm" action="${path}/lendInfo/exportExcel/1" method="get">
					&nbsp;&nbsp;&nbsp;&nbsp;
					投资时间  :  
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<%-- <a href="${path}/lendInfo/exportExcel" class="easyui-linkbutton" >导出Excel</a> --%>
