...
<div class="easyui-layout" data-options="fit:true,selected:true">
    <div class="datagrid-toolbar" data-options="region:'north',split:true,title:'查询'" style="height:130px;padding:20px 0px 10px 30px">
        <form id="queryForm" method="get" action="${ctx}/lendInfo/exportExcel/10">
...
function initParamInfoGrid(){
	$('#paramInfo').datagrid({
        ...
        fit:true,
        loadMsg: '加载数据，请稍候...',
	    url:'${ctx}/lendInfo/ten/datagrid',  
	    title:'首投 、有邀请码的不计入 、定期产品、首次投资满500元、单笔复投金额≥10000元、用户注册手机号显示 、有邀请码的不计入 ',
	    columns:[[    
