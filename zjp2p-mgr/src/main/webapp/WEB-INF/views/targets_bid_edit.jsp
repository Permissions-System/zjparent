          ...
          <div class="am-divider"><hr>
           ...
           <div class="am-form-group am-input-group-sm">
            ...
            <div class="am-u-sm-10">
              <input type="text" class="am-input-sm" id="bidclassname" name="bidclassname" placeholder="产品名称" style="float:left; width: 55%;" value="${bid.bidclassname}" maxlength="18"><span style="float:left; color:#F00; height:40px; line-height:40px; margin-left:10px; font-size:20px;"> <small style="color: black;">9个字以内</small>*</span>
            </div>
          </div>
          <div class="am-form-group am-input-group-sm">
...
<div class="am-form-group">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-10">
              <input type="text" class="am-input-sm" id="investperiod" name="investperiod" style="float:left; width: 25%;" value="${bid.investperiod}"><span style="float:left; height:40px; line-height:40px; margin-left:10px;">个月</span><span style="float:left; color:#F00; height:40px; line-height:40px; margin-left:10px; font-size:20px;"> *</span>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-10">
              <input type="text" class="am-input-sm" id="raiseperiod" name="raiseperiod" style="float:left; width: 150px;" value="${bid.raiseperiod}"><span style="float:left; height:40px; line-height:40px; margin-left:10px;">天</span><span style="float:left; color:#F00; height:40px; line-height:40px; margin-left:10px; font-size:20px;"> *</span>
            </div>
          </div>
...
<!-- 							100%本息保障 <input type="hidden" name="ensuretype" value="1"> -->
    ...
    <div class="tagconfirm"><button type="button" id="save" class="am-btn am-btn-secondary">保 存</button> <button type="button" id="publish" class="am-btn am-btn-secondary">保存并发标</button> <button type="button" class="am-btn am-btn-success" id="preview">预 览</button> 
