...
{
  Logger logger = LoggerFactory.getLogger(DesUtil.class);
  ...
  public static void main(String[] args)
  {
    ...
    String tKey = "co";
    String data = "~`!@#$%^&*()_+{}|:\"<>-=[];',.?/'";
    String strs = ttt.strEncode(data, fKey, sKey, tKey);
    String decs = ttt.strDecode("79891365add1e34a8aed777b77a59144820edf397efd6c45015edd5b471bffb8c9a492f03acd978dd21395855ead31b81f23f17b172be8c383b9d1f20b0752d7", fKey, sKey, tKey);
  }

  public String strEncode(String data, String firstKey, String secondKey, String thirdKey)
  {
    String encData = "";
    ...
    if ((data == null) || ("".equals(data))) {
      ...
      List firstKeyBt = null; List secondKeyBt = null; List thirdKeyBt = null;
      int firstLength = 0; int secondLength = 0; int thirdLength = 0;
  ...
  public String strDecode(String data, String firstKey, String secondKey, String thirdKey)
  {
    String decStr = "";
    if ((data == null) && ("".equals(data))) {
      decStr = "";
      ...
      for (i = 0; i < iterator; ++i) {
        ...
        if ((firstKey != null) && (!("".equals(firstKey))) && (secondKey != null) && (!("".equals(secondKey))) && (thirdKey != null) && (!("".equals(thirdKey))))
        {
          ...
          for (x = thirdLength - 1; x >= 0; --x) {
            tempBt = dec(tempBt, (int[])(int[])thirdKeyBt.get(x));
          }
          for (y = secondLength - 1; y >= 0; --y) {
            tempBt = dec(tempBt, (int[])(int[])secondKeyBt.get(y));
          }
        ...
        else if ((firstKey != null) && (!("".equals(firstKey))) && (secondKey != null) && (!("".equals(secondKey))))
        {
          ...
          for (x = secondLength - 1; x >= 0; --x) {
            tempBt = dec(tempBt, (int[])(int[])secondKeyBt.get(x));
          }
          for (y = firstLength - 1; y >= 0; --y) {
            tempBt = dec(tempBt, (int[])(int[])firstKeyBt.get(y));
          }
          decByte = tempBt;
        }
        else if ((firstKey != null) && (!("".equals(firstKey))))
        {
          ...
          for (x = firstLength - 1; x >= 0; --x) {
            tempBt = dec(tempBt, (int[])(int[])firstKeyBt.get(x));
          }
          decByte = tempBt;
        }
  ...
  public int[] enc(int[] dataByte, int[] keyByte)
  {
    ...
    int i = 0; int j = 0; int k = 0; int m = 0; int n = 0;
    for (k = 0; k < 32; ++k) {
      ipLeft[k] = ipByte[k];
  ...
  public int[] initPermute(int[] originalData) {
    ...
    int i = 0; int m = 1; int n = 0;
    i = 0; m = 1; for (n = 0; i < 4; n += 2) {
      int j = 7; for (int k = 0; j >= 0; ++k) {
  ...
  public int[][] generateKeys(int[] keyByte)
  {
    ...
    for (i = 0; i < 16; ++i) {
      ...
      {
      case 0:
        for (m = 0; ; ++m) { if (m >= 48) break label1206;
          keys[0][m] = tempKey[m];
        }
      case 1:
        for (m = 0; ; ++m) { if (m >= 48) break label1206;
