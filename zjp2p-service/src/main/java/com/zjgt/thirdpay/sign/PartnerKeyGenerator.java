...
public class PartnerKeyGenerator
{
  ...
  public static synchronized PublicKey getPublicKey(String path) {
    ...
    InputStream in = null;
    try {
      in = PartnerKeyGenerator.class.getClassLoader().getResourceAsStream(path);
  ...
  public static synchronized PrivateKey getPrivateKey(String keypair, String storePass, String path)
  {
    ...
    try
    {
      ...
      char[] kpass = new char[storePass.length()];
